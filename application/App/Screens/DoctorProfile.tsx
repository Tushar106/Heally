            ...
            <ScrollView >
                <View style={{ width: "100%", backgroundColor: "#f3f6f5", padding: 10, borderRadius: 5, gap: 10 }}>
                    ...
                    <View>
                        ...
                        <Text style={{ fontSize: 15 }}>{doctor.about ? doctor.about : <>{doctor.name} is a well known doctor in the field of Gynecology and Pharma. He has been working in the field for more than 10 years. He has a good reputation among his patients.</>}</Text>
                    </View>
